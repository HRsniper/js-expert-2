        ...
        (module.exports = i),
          ...
          (r.prototype.unpack_uint64 = function () {
            var t = this.read(8),
              e =
                256 *
                  (256 * (256 * (256 * (256 * (256 * (256 * t[0] + t[1]) + t[2]) + t[3]) + t[4]) + t[5]) +
                    t[6]) +
                t[7];
          ...
          (r.prototype.unpack_double = function () {
            ...
            return (
              (0 === t >> 31 ? 1 : -1) *
              (((1048575 & t) | 1048576) * Math.pow(2, i - 20) + e * Math.pow(2, i - 52))
            );
          }),
          ...
          (n.prototype.pack = function (t) {
            ...
            if ("string" === i) this.pack_string(t);
              ...
              !0 === t ? this.bufferBuilder.append(195) : !1 === t && this.bufferBuilder.append(194);
              ...
              if (null === t) this.bufferBuilder.append(192);
                ...
                if (r == Array) this.pack_array(t);
                  ...
                  e.useArrayBufferView ? this.pack_bin(new Uint8Array(t)) : this.pack_bin(t);
                else if ("BYTES_PER_ELEMENT" in t)
                  e.useArrayBufferView ? this.pack_bin(new Uint8Array(t.buffer)) : this.pack_bin(t.buffer);
    ...
    iSxC: [
      function (require, module, exports) {
        ...
        function a(e) {
          return "boolean" != typeof e
            ? new Error("Argument type: " + t(e) + ". Please use a boolean.")
            : ((r = !e), "adapter.js deprecation warnings " + (e ? "disabled" : "enabled"));
        }
        function u() {
                    ...
                    if ("require" !== t && "advanced" !== t && "mediaSource" !== t) {
                      ...
                      void 0 !== n.exact && "number" != typeof n.exact
                        ...
                        : ["min", "max"].forEach(function (e) {
                            void 0 !== n[e] &&
                              ((r.mandatory = r.mandatory || {}), (r.mandatory[i(e, t)] = n[e]));
                          });
                    }
                  }),
                  ...
                  if (
                    ...
                    if (
                      ...
                      "environment" === d.exact || "environment" === d.ideal
                        ? (u = ["back", "rear"])
                        : ("user" !== d.exact && "user" !== d.ideal) || (u = ["front"]),
                      u)
                    )
        ...
        function c(t) {
          if ("object" !== s(t) || !t.RTCPeerConnection || "ontrack" in t.RTCPeerConnection.prototype)
            e.wrapPeerConnectionEvent(t, "track", function (e) {
              return (
                e.transceiver || Object.defineProperty(e, "transceiver", { value: { receiver: e.receiver } }),
                e
              );
            });
          else {
      ...
      function (require, module, exports) {
        ...
        (r.localCName = r.generateIdentifier()),
          ...
          (r.writeCandidate = function (r) {
            ...
            return (
              ...
              "host" !== t &&
                r.relatedAddress &&
                r.relatedPort &&
                (e.push("raddr"), e.push(r.relatedAddress), e.push("rport"), e.push(r.relatedPort)),
          ...
          (r.parseSsrcMedia = function (r) {
            ...
            return (
              n > -1
                ? ((t.attribute = r.substr(e + 1, n - e - 1)), (t.value = r.substr(n + 1)))
          ...
          (r.writeMediaSection = function (e, t, n, a) {
            ...
            return (
              ...
              e.rtpSender &&
                e.sendEncodingParameters[0].rtx &&
                (s += "a=ssrc:" + e.sendEncodingParameters[0].rtx.ssrc + " cname:" + r.localCName + "\r\n"),
              s
            );
          }),
      ...
      function (require, module, exports) {
        ...
        function r(t, r, n, a, i) {
          ...
          return (
            ...
            t.rtpSender &&
              t.sendEncodingParameters[0].rtx &&
              (s += "a=ssrc:" + t.sendEncodingParameters[0].rtx.ssrc + " cname:" + e.localCName + "\r\n"),
            s
          );
        }
        function n(e, t) {
        ...
        module.exports = function (c, d) {
          ...
          var f = function (t) {
            ...
            if (
              ((t.iceServers = n(t.iceServers || [], d)), (this._iceGatherers = []), t.iceCandidatePoolSize)
            )
              for (var i = t.iceCandidatePoolSize; i > 0; i--)
                this._iceGatherers.push(
                  new c.RTCIceGatherer({ iceServers: t.iceServers, gatherPolicy: t.iceTransportPolicy })
                );
          ...
          Object.defineProperty(f.prototype, "localDescription", {
            ...
            (f.prototype.setLocalDescription = function (t) {
              ...
              if (-1 === ["offer", "answer"].indexOf(t.type))
                return Promise.reject(o("TypeError", 'Unsupported type "' + t.type + '"'));
              if (!i("setLocalDescription", t.type, s.signalingState) || s._isClosed)
                return Promise.reject(
                  o("InvalidStateError", "Can not set local " + t.type + " in state " + s.signalingState)
                );
              if ("offer" === t.type)
                ...
                r.forEach(function (t, r) {
                  ...
                  if (!(e.isRejected(t) && 0 === e.matchPrefix(t, "a=bundle-only").length) && !i.rejected) {
                    ...
                    c && (v.role = "server"),
                      (s.usingBundle && 0 !== r) ||
                        (s._gather(i.mid, r),
                        "new" === d.state && d.start(o, u, c ? "controlling" : "controlled"),
            ...
            (f.prototype.setRemoteDescription = function (t) {
              ...
              if (!i("setRemoteDescription", t.type, r.signalingState) || r._isClosed)
                return Promise.reject(
                  o("InvalidStateError", "Can not set remote " + t.type + " in state " + r.signalingState)
                );
              var n = {};
              ...
              return (
                ...
                u.forEach(function (i, o) {
                  ...
                  if (g || ("application" === u && ("DTLS/SCTP" === y || "UDP/DTLS/SCTP" === y)))
                    r.transceivers[o] = { mid: E, kind: u, protocol: y, rejected: !0 };
                  else {
                    ...
                    g || ((I = e.getIceParameters(i, v)), ((L = e.getDtlsParameters(i, v)).role = "client")),
                    ...
                    if (
                      (("offer" === t.type || "answer" === t.type) &&
                        ...
                        r.transceivers[o].rtpSender &&
                          r.transceivers[o].rtpSender.setTransport(r.transceivers[0].dtlsTransport),
                        r.transceivers[o].rtpReceiver &&
                          r.transceivers[o].rtpReceiver.setTransport(r.transceivers[0].dtlsTransport)),
                      "offer" !== t.type || g)
                    ) {
                      if ("answer" === t.type && !g) {
                        (P = (C = r.transceivers[o]).iceGatherer),
                          ...
                          !_ || ("sendrecv" !== S && "sendonly" !== S)
                            ...
                            : ((D = _.track),
                              T
                                ? (n[T.stream] || (n[T.stream] = new c.MediaStream()),
                                  p(D, n[T.stream]),
                                  f.push([D, _, n[T.stream]]))
                                : (n.default || (n.default = new c.MediaStream()),
                                  p(D, n.default),
                      ...
                      if ("sendrecv" === S || "sendonly" === S) {
                        if (
                          ((A = !C.rtpReceiver),
                          (_ = C.rtpReceiver || new c.RTCRtpReceiver(C.dtlsTransport, u)),
                          A)
                        )
                          (D = _.track),
                            (T && "-" === T.stream) ||
                        ...
                        C.rtpReceiver &&
                          ...
                          (C.associatedRemoteMediaStreams.forEach(function (e) {
                            ...
                            n &&
                              ((t = n),
                              (r = e).removeTrack(t),
                              r.dispatchEvent(new c.MediaStreamTrackEvent("removetrack", { track: t })));
                          }),
              ...
              t.transceivers.forEach(function (r, n) {
                ...
                d < 15019 &&
                  ...
                  o.headerExtensions.forEach(function (e) {
                    ((r.remoteCapabilities && r.remoteCapabilities.headerExtensions) || []).forEach(function (
                      t
                    ) {
            ...
            (f.prototype.createAnswer = function () {
              ...
              if ("have-remote-offer" !== t.signalingState && "have-local-pranswer" !== t.signalingState)
                return Promise.reject(
                  o("InvalidStateError", "Can not call createAnswer in signalingState " + t.signalingState)
                );
                ...
                if (!(s + 1 > i)) {
                  ...
                  if (e.stream)
                    "audio" === e.kind
                      ...
                      : "video" === e.kind && (o = e.stream.getVideoTracks()[0]),
                      o &&
                        d >= 15019 &&
                        "video" === e.kind &&
                        !e.sendEncodingParameters[0].rtx &&
              ...
              return t && void 0 === t.sdpMLineIndex && !t.sdpMid
                ...
                : new Promise(function (a, i) {
                    if (!n._remoteDescription)
                      return i(
                        o("InvalidStateError", "Can not add ICE candidate without a remote description")
                      );
                    if (t && "" !== t.candidate) {
                      ...
                      if (
                        (0 === c || (c > 0 && p.iceTransport !== n.transceivers[0].iceTransport)) &&
                        !s(p.iceTransport, l)
                      )
                        return i(o("OperationError", "Can not add ICE candidate"));
                      var f = t.candidate.trim();
                      0 === f.indexOf("a=") && (f = f.substr(2)),
                        ((r = e.getMediaSections(n._remoteDescription.sdp))[c] +=
                ...
                if (
                  (this.transceivers.forEach(function (r) {
                    r.rtpSender && r.rtpSender.track === e
                      ? (t = r.rtpSender)
                      : r.rtpReceiver && r.rtpReceiver.track === e && (t = r.rtpReceiver);
                  }),
                  !t)
                )
        ...
        function n(t) {
          ...
          if (
            ((n.getUserMedia = function (t, o, r) {
              e.deprecated("navigator.getUserMedia", "navigator.mediaDevices.getUserMedia"),
          ...
          (e.navigator.mediaDevices && "getDisplayMedia" in e.navigator.mediaDevices) ||
            (e.navigator.mediaDevices &&
              (e.navigator.mediaDevices.getDisplayMedia = function (a) {
                ...
                return (
                  !0 === a.video ? (a.video = { mediaSource: i }) : (a.video.mediaSource = i),
                  e.navigator.mediaDevices.getUserMedia(a)
                );
              }));
        }
              ...
              (e.RTCPeerConnection.prototype.addTransceiver = function () {
                ...
                if (r) {
                  ...
                  "encodings" in i ||
                    ...
                    this.setParametersPromises.push(o.setParameters(i).catch(function () {})));
                }
                return n;
              });
          }
                  ...
                  c = (function (t, n) {
                    ...
                    return (
                      i.length > 0
                        ...
                        : "firefox" === o.browser && -1 !== n && (r = 2147483637),
                      r
                    );
                  })(arguments[0], i);
                n =
          ...
          switch (h.browser) {
            ...
            case "firefox":
              if (!s || !s.shimPeerConnection || !o.shimFirefox)
                return m("Firefox shim is not included in this adapter release."), d;
            ...
            case "edge":
              if (!i || !i.shimPeerConnection || !o.shimEdge)
                return m("MS edge shim is not included in this adapter release."), d;
        ...
        exports.util = new ((function () {
          ...
          return (
            ...
            (r.prototype.chunk = function (r) {
              for (
                var t = [], e = r.size, o = Math.ceil(e / exports.util.chunkedMTU), n = 0, a = 0;
                a < e;
              ...
              (o.prototype.start = function (e, t) {
                ...
                !this._socket &&
                  ...
                  (this._socket.onopen = function () {
                    n._disconnected ||
                      (n._sendQueuedMessages(), i.default.log("Socket open"), n._scheduleHeartbeat());
                  }));
              }),
          ...
          a = (function () {
            ...
            return (
                  ...
                  (e.onicecandidate = function (e) {
                    e.candidate &&
                      ...
                      s.socket.send({
                        ...
                        payload: { candidate: e.candidate, type: a, connectionId: o },
                        dst: t
                      }));
                  }),
                      ...
                      case "failed":
                        r.default.log("iceConnectionState is failed, closing connections to " + t),
                          n.connection.emit(
                            ...
                            new Error("Negotiation of connection to " + t + " failed.")
                          ),
                          n.connection.close();
                        break;
                      case "closed":
                        ...
                        break;
                      case "disconnected":
                        r.default.log("iceConnectionState is disconnected, closing connections to " + t),
                          n.connection.emit(
                            c.ConnectionEventType.Error,
                ...
                return n(this, void 0, Promise, function () {
                  ...
                  return t(this, function (t) {
                    switch (t.label) {
                      ...
                      case 1:
                        return (
                          t.trys.push([1, 7, , 8]), [4, n.createOffer(this.connection.options.constraints)]
                        );
                      case 2:
                        (a = t.sent()),
                      ...
                      case 5:
                        return (
                          "OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer" !=
                            ...
                            r.default.log("Failed to setLocalDescription, ", l)),
                          [3, 6]
                        );
                      case 6:
                        return [3, 8];
                  ...
                  return t(this, function (t) {
                    switch (t.label) {
                      ...
                      case 2:
                        return (
                          t.sent(),
                          r.default.log("Set remoteDescription:" + e + " for:" + this.connection.peer),
                      ...
                      case 1:
                        return (
                          ...
                          [
                            4,
                            a.addIceCandidate(
                              new RTCIceCandidate({ sdpMid: i, sdpMLineIndex: o, candidate: n })
                            )
                          ]
                        );
                      case 2:
                        return (
                          t.sent(), r.default.log("Added ICE candidate for:" + this.connection.peer), [3, 4]
                        );
                      case 3:
                        return (
                          (d = t.sent()),
              ...
              (o.prototype._addStreamToMediaConnection = function (e, n) {
                r.default.log("add stream " + e.id + " to media connection " + n.connectionId),
                  n.addStream(e);
              }),
              o
            );
        ...
        var e = require("eventemitter3"),
          r = (function (e) {
            function r(t, r, n) {
              ...
              return (
                (o.peer = t), (o.provider = r), (o.options = n), (o._open = !1), (o.metadata = n.metadata), o
              );
            }
            return (
              t(r, e),
            ...
            function s(e, t, l) {
              ...
              return (
                ...
                f._encodingQueue.on("error", function () {
                  o.default.error(
                    "DC#" + f.connectionId + ": Error occured in encoding from blob to arraybuffer, close DC"
                  ),
                    f.close();
                }),
            ...
            return (
              ...
              (s.prototype._configureDataChannel = function () {
                ...
                (i.util.supports.binaryBlob && !i.util.supports.reliable) ||
                  ...
                  (this.dataChannel.onopen = function () {
                    o.default.log("DC#" + e.connectionId + " dc connection success"),
                      (e._open = !0),
              ...
              (s.prototype._trySend = function (e) {
                ...
                try {
                  ...
                  return (
                    o.default.error("DC#:" + this.connectionId + " Error when sending:", n),
                    (this._buffering = !0),
                    this.close(),
                    !1
                  );
                    ...
                    switch (e.label) {
                      ...
                      case 3:
                        throw (
                          ...
                          new Error("Could not get list peers from the server." + i))
                        );
                      case 4:
                        return [2];
                    }
          ...
          f = (function (o) {
            function i(e, n) {
              ...
              return (
                ...
                c._options.path &&
                  ("/" !== c._options.path[0] && (c._options.path = "/" + c._options.path),
                  "/" !== c._options.path[c._options.path.length - 1] && (c._options.path += "/")),
            ...
            return (
              ...
              (i.prototype._createServerConnection = function () {
                ...
                return (
                  ...
                  t.on(u.SocketEventType.Disconnected, function () {
                    e.disconnected ||
                      (e.emitError(u.PeerErrorType.Network, "Lost connection to server."), e.disconnect());
                  }),
                  t.on(u.SocketEventType.Close, function () {
                    e.disconnected ||
                      e._abort(u.PeerErrorType.SocketClosed, "Underlying socket is already closed.");
                  }),
                  t
                );
              }),
                  ...
                  case u.ServerMessageType.Offer:
                    ...
                    if (
                      ((_ = this.getConnection(s, c)) &&
                        (_.close(), a.default.warn("Offer received for existing Connection ID:" + c)),
                      ...
                      if (i.type !== u.ConnectionType.Data)
                        return void a.default.warn("Received malformed connection type:" + i.type);
                  ...
                  default:
                    if (!i)
                      return void a.default.warn(
                        "You received a malformed message from " + s + " of type " + o
                      );
                    var _;
                    c = i.connectionId;
              ...
              (i.prototype.reconnect = function () {
                if (this.disconnected && !this.destroyed)
                  a.default.log("Attempting reconnection to server with ID " + this._lastServerId),
                    (this._disconnected = !1),
